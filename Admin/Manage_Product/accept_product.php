          ...
          <div class="tile">
            <div class="tile-body">
              <div class="table-responsive">
                  ...
                  <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM prd_info 
                                    ...
                                    inner join ward ON prd_info.ward_id=ward.ward_id WHERE prd_status = 1" ;// ORDER BY id_table DESC 
                ...
                <td class="form-group">
                    <p><a href="index.php?page_layout=acp_controller&id=<?php echo $row['prd_id']; ?>" class="btn btn-primary">Duyệt</a></p>
                    <!-- Button trigger modal -->
                    <a onclick="$('#dialog-example_<?php echo $row['prd_id'] ?>').modal('show');" href="#" class="btn btn-danger" data-0toggle="modal" data-target="#exampleModal">Xóa</a>
                </td>
                <!-- Modal -->
