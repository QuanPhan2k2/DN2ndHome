                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($query)) { ?>
                                    ...
                                    <td><span class="label label-<?php if($row['user_level']==1){echo "danger";}else{echo 'success';}?>"><?php if($row['user_level']==1){echo 'Admin';}else{echo 'User';}?></span></td>
                ...
                <div class="modal-content" id="dialog-example_<?php echo $row['user_id'] ?>">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Bạn thực sự muốn xóa
                         <span style="color:red">người dùng: "<?php echo $row['username'].'" , ID: "'.$row['user_id']; ?>"
                          </span> không?</h5>
